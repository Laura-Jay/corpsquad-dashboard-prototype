...
const id1 = "59bcf5e767dfaab0db908acc";
...
const id2 = "c287aad50a87ae6aada1175f";
...
test("returns all projects which contain the given id in employeeIds array", () => {
  expect(findProjectsFromEmployee(id1, testProjects1)).toStrictEqual([
    {
      id: "f0b83d3a0b77da97ec7eefc4",
      clientId: "2ebfad09bacb0c0cc031b5fa",
      employeeIds: [
  ...
  expect(findProjectsFromEmployee(id2, testProjects2)).toStrictEqual([
    {
      id: "f0b83d3a0b77da97ec7eefc4",
      clientId: "2ebfad09bacb0c0cc031b5fa",
      employeeIds: [
  ...
  expect(findProjectsFromEmployee(id3, testProjects3)).toStrictEqual([]);
  expect(findProjectsFromEmployee(id4, testProjects4)).toStrictEqual([]);
});
